    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
             ...
             <input type="hidden" name="foto" value="<?php echo $p->product_iamges ?>">
             <input type="file" name="gambar" class="input-control">
             <textarea class="input-control" name="deskripsi" placeholder="Deskripsi"><?php echo $p->product_description ?></textarea></textarea>
             <select class="input-control" name="status">
                <option value="">--Pilih--</option>
                <option value="1" <?php echo ($p->product_status == 1)? 'selected':''; ?>>Aktip</option>
