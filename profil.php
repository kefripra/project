        ...
        <div class="container">
            ...
            <div class="box">
             <form action="" method="POST">
                ...
                <input type="password" name="pass2" placeholder="Konfirmasi Password" class="input-control" value="<?php echo $d->username ?>" required>
                <input type="submit" name="ubah password" value="Ubah Profil" class="btn">
             </form>
             <?php 
